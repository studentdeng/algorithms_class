...
//  Graph_c++
//
//  Created by yg curer on 13-2-18.
...
int main() {
    ...
    for (int i = 0; i < RETRY_TIME; i++) {
        ...
        if (i % 100 == 0) {
            cout << "number :"<<  i << " result is " << mincut / 2 <<endl;
        }
    }
    ...
    ifstream ifs;
    ifs.open("/Volumes/Macintosh HD/Users/ygcurer/code/Graph_c++/scc.txt");
    string line;
    ...
    int num = 0;
    int value = 1;
    for (vector<int>::iterator it = scc.id.begin() + 1; it != scc.id.end(); ++it) {
    ...
    for (vector<int>::reverse_iterator it = countList.rbegin(); it != countList.rend(); ++it) {
    ...
    /*
    EdgeWeightedDirgraph g;
    
    ifstream ifs;
    ifs.open("/Users/ygcurer/code/Graph_c++/dijkstraData.txt");
    string line;
    stringstream strstream;
    int v, e;
    double weight;
...
void Graph::ReadGraphFromText() {
    ifstream ifs;
    ifs.open("/Users/ygcurer/code/Graph_c++/mincut.txt");
    string line;
    stringstream strstream;
    int v, e;
